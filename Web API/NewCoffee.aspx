...
<asp:Content ID="Content2" ContentPlaceHolderID="Breadcrumb" runat="server">
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Add New Coffee</li>
      </ol>
    </nav>
</asp:Content>
       ...
       <form id="border">
             ...
             <div id="button-group">
                <table>
                  <tr>
                       <td>
                            <button type="button" onclick="newCoffee()" class="btn btn-primary" id="save">New Coffee</button>
                       </td>
                  </tr>
                </table>
            </div>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHoldersJS" runat="server">
    ...
    <script src='<%= ResolveUrl("JavaScript/Save.js") %>' type="text/javascript"></script>
</asp:Content>
